...
{
	std::vector<svg::location> locations;
	add_cluster_near(locations, svg::location(20, 20), 10, 1);
	add_cluster_near(locations, svg::location(50, 50), 10, 1.1);
	add_cluster_near(locations, svg::location(105, 110), 10, 0.8);
	add_cluster_near(locations, svg::location(100, 20), 10, 1.2);
	add_cluster_near(locations, svg::location(20, 70), 10, 1.05);
	...
	BOOST_CHECK_CLOSE_FRACTION(20.0, clusters[0].x, 0.4);
	BOOST_CHECK_CLOSE_FRACTION(20.0, clusters[0].y, 0.4);
	BOOST_CHECK_CLOSE_FRACTION(50.0, clusters[1].x, 0.1);
	BOOST_CHECK_CLOSE_FRACTION(50.0, clusters[1].y, 0.1);
	BOOST_CHECK_CLOSE_FRACTION(20.0, clusters[2].x, 0.3);
	BOOST_CHECK_CLOSE_FRACTION(70.0, clusters[2].y, 0.1);
	BOOST_CHECK_CLOSE_FRACTION(100.0, clusters[3].x, 0.1);
	BOOST_CHECK_CLOSE_FRACTION(20.0, clusters[3].y, 0.5);
	BOOST_CHECK_CLOSE_FRACTION(105.0, clusters[4].x, 0.1);
	BOOST_CHECK_CLOSE_FRACTION(110.0, clusters[4].y, 0.1);
}
